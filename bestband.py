...
import numpy as np
"""
    Testing the best composition obtained through the ebouhid/BandSelection feature selection study (based on evolutional algorithms).
    Testing the combination: [1, 4, 5, 6, 7]
"""
